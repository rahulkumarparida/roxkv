...
import "github.com/rahulkumarparida/roxkv/agents/abstractor"
...
func KvAgentTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["query"] = abstractor.GenericToolProperty{
		Type:        "string",
	...
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
...
func MonitorAgentTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["query"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func PubSubAgentTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["query"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func StorageAgentTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["query"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func GetComputerUsageTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetCPUUsageTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetRAMUsageTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetDiskUsageTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)

	pathProp := abstractor.GenericToolProperty{
		Type:        "string",
...
func GetRuntimeStatsTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetServerUptimeTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetConnectedClientsTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetCommandCountTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
...
func GetAllTopicsOnlineTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetAllSubscribersTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetAllPublishersTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetPublishersTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func GetSubscribersTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func GetTopicStatisticsTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func GetInactiveTopicsTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func BroadcastToTopicTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
		Description: "Master agent capability: publish one message to a single topic. Use this for targeted broadcasts.",
	}
	properties["message"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func BroadcastEverywhereTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["message"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func HistoryOfTopicTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func DeleteTopicTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func CreateTopicTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["topic"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func RemoveUserTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["portaddress"] = abstractor.GenericToolProperty{
		Type:        "string",
	...
	properties["reason"] = abstractor.GenericToolProperty{
		Type:        "string",
...
func GetTotalKeysTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetLargestKeysTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["top_n"] = abstractor.GenericToolProperty{
		Type:        "integer",
...
func GetSmallestKeysTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["top_n"] = abstractor.GenericToolProperty{
		Type:        "integer",
...
func GetAverageValueSizeTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetNamespacesTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetTTLMetricsTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetExpiredKeysTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetUpcomingExpirationsTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["top_n"] = abstractor.GenericToolProperty{
		Type:        "integer",
...
func GetKeysWithoutTTLTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetSnapshotCountTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetLatestSnapshotTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetSnapshotSizeTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetPersistenceHealthTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetOldestKeyTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetNewestKeyTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetMostAccessedKeyTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetLeastAccessedKeyTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	toolParams := abstractor.GenericToolParameters{
		Type:       "object",
		Properties: properties,
...
func GetRecentlyModifiedKeysTool() abstractor.GenericToolDefinition {
	properties := make(map[string]abstractor.GenericToolProperty)
	properties["top_n"] = abstractor.GenericToolProperty{
		Type:        "integer",
...
func GetKeyTool() abstractor.GenericToolDefinition {

	var properties = make(map[string]abstractor.GenericToolProperty)

	keyprop := abstractor.GenericToolProperty{
		Type:        "string",
	...
	var GetKeyValueTool = abstractor.GenericToolDefinition{
		Type:        "function",
		Name:        "get",
...
func SetKeyTool() abstractor.GenericToolDefinition {
	...
	valprop := abstractor.GenericToolProperty{
		Type:        "string",
		Description: "String value to store under the provided key.",
	}

	properties["key"] = keyprop
	properties["value"] = valprop
	...
	var SetKeyValueTool = abstractor.GenericToolDefinition{
		Type:        "function",
		Name:        "set",
...
func DeleteKeyTool() abstractor.GenericToolDefinition {
	var properties = make(map[string]abstractor.GenericToolProperty)
	...
	var DeleteValueTool = abstractor.GenericToolDefinition{
		Type:        "function",
		Name:        "del",
...
func KeysTool() abstractor.GenericToolDefinition {
	var properties = make(map[string]abstractor.GenericToolProperty)
	...
	var ListKeysTool = abstractor.GenericToolDefinition{
		Type:        "function",
		Name:        "keys",
...
func SaveTool() abstractor.GenericToolDefinition {
	var properties = make(map[string]abstractor.GenericToolProperty)
	...
	var SaveDiskTool = abstractor.GenericToolDefinition{
		Type:        "function",
		Name:        "save",
...
func LoadTool() abstractor.GenericToolDefinition {
	var properties = make(map[string]abstractor.GenericToolProperty)
	...
	var LoadDiskTool = abstractor.GenericToolDefinition{
		Type:        "function",
		Name:        "load",
